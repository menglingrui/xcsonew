...
public class SaleorderBVO extends SmartVO implements Comparable, ISOInventoryDiscount, IEqualValueUpBill,
	...
	public static synchronized int[] getCalculatePara(String key, Integer Prior, UFBoolean SA_02, String SO40) {
		...
		if (SO40.equals("调整单价")) /*-=notranslate=-*/
	...
	public transient static String[] numkeys = { "nnumber","npacknumber","nquoteunitnum" };

    public transient static HashSet hsnumkey;
	 ...
	 * @return 返回 ntotalinventorynumber_old。
	 */
	public static HashSet getHsnumkey() {
		if (hsnumkey == null) {
			hsnumkey = new HashSet();
			for (int i = 0, loop = numkeys.length; i < loop; i++) {
				hsnumkey.add(numkeys[i]);
			}
		}
		return hsnumkey;
	}
	 ...
	 * @return 返回 ntotalinventorynumber_old。
	 */
	public static boolean isPriceNumMny(String key) {
		if (SoVoTools.isEmptyString(key))
			return false;
		return getHspricemnykey().contains(key) || getHsnumkey().contains(key);
	}
	...
	public String getCt_managebid() {
		return (String) getAttributeValue("ct_managebid");
	}
	...
	public void setCt_managebid(String value) {
		setAttributeValue("ct_managebid", value);
	}
	...
	public UFBoolean getBifinventoryfinish() {
		...
		return value==null?UFBoolean.FALSE:m_SVODataUtils.getUFBoolean(value);
	}
...
//		Object value = getAttributeValue("nbalmny_diff");
	...
	public void validate() throws nc.vo.pub.ValidationException {
		...
		if (!(getDiscountflag() != null && getDiscountflag().booleanValue())) {
			if (getNnumber() == null || getNnumber().doubleValue() == .0) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0002282")/*
				 * @res
				 * "数量"
				 */);
			}
			if (getNquoteunitnum() == null || getNquoteunitnum().doubleValue() == .0) {
		...
		if (getNexchangeotobrate() == null || getNexchangeotobrate().compareTo(UFDouble.ZERO_DBL) <= 0) {
			errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000563"));
		}
			
		// 跨公司
		if (getCconsigncorpid() != null && getCconsigncorpid().trim().length() > 0
				&& getPk_corp()!=null &&!getPk_corp().equals(getCconsigncorpid())) {
			if (getCinventoryid1() == null || getCinventoryid1().trim().length() <= 0) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000193"));
			}
			if (getCreccalbodyid() == null || getCreccalbodyid().trim().length() <= 0) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000202"));
			}
			if (getBdericttrans() == null || !getBdericttrans().booleanValue()) {
				if (getCrecwareid() == null || getCrecwareid().trim().length() <= 0) {
					errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000203"));
				}
			}
			if (getLaborflag() != null && getLaborflag().booleanValue()) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000204"));
			}
			if (getDiscountflag() != null && getDiscountflag().booleanValue()) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000205"));
			}
		}
		//本公司
		else{
			if (getCadvisecalbodyid() == null || getCadvisecalbodyid().trim().length() <= 0) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000206"));
			}
			if ((getFbatchstatus() != null && getFbatchstatus().intValue() == 1)
					&& (getCbatchid() == null || getCbatchid().trim().length() == 0)) {
				errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPP40060301-000215"));
			}
		}
		//for add mlr
		if(PubBillTypeConst.billtype_soct.equals(getCreceipttype())){
			return;
		}
		
		if (!(getBlargessflag() != null && getBlargessflag().booleanValue())){
			if (getNoriginalcursummny() == null || getNoriginalcursummny().doubleValue()==.0) {
...
//			if (errFields.size() == 0) {
				...
				if (getNoriginalcurtaxprice()==null)
					errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0001160")/*
							 * @res
							 * "含税单价"
							 */);
				if (getNoriginalcurprice()==null)
					errFields.add(NCLangRes4VoTransl.getNCLangRes().getStrByID("common", "UC000-0002306")/*
							 * @res
							 * "无税单价"
							 */);
				...
				if (getNoriginalcurmny()!=null
						&& getNoriginalcurtaxmny()!=null
						&& getNoriginalcursummny()!=null
						&& getNoriginalcurmny().add(getNoriginalcurtaxmny()).doubleValue()!=getNoriginalcursummny().doubleValue()){
					throw new ValidationException(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPT40060301-000609") + getCrowno() + nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301", "UPT40060301-000610"));
				}
		}
		...
		if (errFields.size() > 0) {
			...
			for (int i = 1; i < temp.length; i++) {
				message.append(NCLangRes4VoTransl.getNCLangRes()
		...
		if (getNdiscountmny() != null && getNdiscountmny().toString().length() > 16) {
			throw new ValidationException(NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301",
					"UPP40060301-000092")/*
			 * @res "折扣额不能过16位"
			 */);
		}
	...
	public static SOField[] getSoSaleOrderBAddFields() {
		...
		if (addSaleOrderBFields == null) {
			...
			sofield = new SOField();
			sofield.setVoname("ct_managebid");
			sofield.setDatabasename("ct_managebid");
			sofield.setUftype(SODataDesc.STRING);
			sofield.setDatabasetype(java.sql.Types.CHAR);
			sofield.setTablename("so_saleorder_b");
			sofields.add(sofield);
	...
	public boolean checkItem4BillRedun(ISourceRedunVO sourceRedunVO) {
		...
		// 直运
			...
			// //直运安排调拨——有直运标记
					...
					&& (getBdericttrans() != null && getBdericttrans().booleanValue()) 
					//配置核算规则Z为直运销售采购流程是不会去做直运调拨标记的，也对错误流程使用控制下 liuzwc 2010-10-29
					&& !"Z".equals(myhead.getVerifyRule()))
				return true;
		}
	...
	public FieldDBValidateVO[] getFieldDBValidateVOs() {
		return	new	FieldDBValidateVO[]{
			new	FieldDBValidateVO(
				AddressField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000642")/*@res "到货地址"*/},
				new	String[]{getVreceiveaddress()}
			),
			new	FieldDBValidateVO(
				DefField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000330")/*@res "自定义项1"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000332")/*@res "自定义项2"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000333")/*@res "自定义项3"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000334")/*@res "自定义项4"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000335")/*@res "自定义项5"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("SCMCOMMON","UPPSCMCommon-000336")/*@res "自定义项6"*/},
				new	String[]{getVdef1(),getVdef2(),getVdef3(),getVdef4(),getVdef5(),getVdef6()}
			),
			new	FieldDBValidateVO(
				DiscountRateField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002289")/*@res "整单扣率"*/
					,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000790")/*@res "扣率"*/},
				new	UFDouble[]{getNdiscountrate(),getNitemdiscountrate()}
			),
			new	FieldDBValidateVO(
				FreeField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003330")/*@res "自由项1"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003333")/*@res "自由项2"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003335")/*@res "自由项3"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003337")/*@res "自由项4"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003339")/*@res "自由项5"*/},
				new	String[]{getVfree1(),getVfree2(),getVfree3(),getVfree4(),getVfree5()}
			),
			new	FieldDBValidateVO(
				MemoField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0001376")/*@res "备注"*/},
				new	String[]{getFrownote()}
			),
			new	FieldDBValidateVO(
				MoneyField.class,
				new	String[]{
					NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000926")/*@res "原币金额"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000922")/*@res "原币税额"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000902")/*@res "原币价税合计"*/,
					NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002615")/*@res "本币金额"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002613")/*@res "本币税额"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002594")/*@res "本币价税合计"*/
					},
				new	UFDouble[]{
			...
			new	FieldDBValidateVO(
				NumField.class,
				new	String[]{
					NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002282")/*@res "数量"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003971")/*@res "辅数量"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("40060301","UPT40060301-000575")/*@res "报价数量"*/},
				new	UFDouble[]{
			...
			new	FieldDBValidateVO(
				PriceField.class,
				new	String[]{
					NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000741")/*@res "单价"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000450")/*@res "净单价"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0001160")/*@res "含税单价"*/,NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000452")/*@res "净含税单价"*/},
				new	UFDouble[]{
					getNoriginalcurprice(),getNoriginalcurnetprice(),getNoriginalcurtaxprice(),getNoriginalcurtaxnetprice()}
			),
			new	FieldDBValidateVO(
				ProduceNumField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002060")/*@res "批次号"*/},
				new	String[]{getCbatchid()}
			),
			new	FieldDBValidateVO(
				RowNoField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003389")/*@res "行号"*/},
				new	UFDouble[]{nc.vo.scm.pub.BillRowNoVO.getUFDouble(getCrowno())}
			),
			new	FieldDBValidateVO(
				TaxRateField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003078")/*@res "税率"*/},
				new	UFDouble[]{getNtaxrate()}
			),
			new	FieldDBValidateVO(
				ToBRateField.class,
				new	String[]{NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002092")/*@res "折本汇率"*/},
